...
class record_odomAction(genpy.Message):
  _md5sum = "11a3f9222d6bf7c37892d9bf53f0aad3"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.result_odm_array)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.result_odm_array:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.result_odm_array = []
      for i in range(0, length):
        ...
        self.action_result.result.result_odm_array.append(val1)
      _x = self
      start = end
      end += 12
