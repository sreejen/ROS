...
class record_odomActionResult(genpy.Message):
  _md5sum = "d72fc03c49d4586b8f5a46dc4451f610"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.result_odm_array)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.result_odm_array:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.result_odm_array.append(val1)
      return self
