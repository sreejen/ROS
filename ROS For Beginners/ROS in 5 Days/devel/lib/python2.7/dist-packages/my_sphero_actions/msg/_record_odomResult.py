...
class record_odomResult(genpy.Message):
  _md5sum = "cd453c62b66583c68284da7f017a9a0c"
...
float64 z"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result_odm_array is None:
        self.result_odm_array = []
    else:
      self.result_odm_array = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.result_odm_array)
      buff.write(_struct_I.pack(length))
      for val1 in self.result_odm_array:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result_odm_array.append(val1)
      return self
